...
export function Lights() {
  const placement = useSceneState((s) => activePlant(s)?.placement ?? 'south-window')
  ...
  useFrame((_, delta) => {
    ...
    // Under glass the light pours in from everywhere, like a south window.
    const sunny = placement === 'south-window' || placement === 'greenhouse'
