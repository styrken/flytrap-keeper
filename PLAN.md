...
- **Kamera & bevægelse:** Man går og hopper rundt i værelset som en lille passer-avatar (WASD/piletaster + mellemrum; virtuelt joystick og Hop-knap på touch). Kameraet er et tredjepersons orbit-kamera der følger figuren: spilleren beholder sin valgte vinkel og zoom og kan dreje hele vejen rundt (360°) — de massive kulisser (vinduesvæggen, husets facade) gemmer sig automatisk, når kameraet svinger om bag dem, så udsigten aldrig blokeres. _(Oprindeligt var scenen et fast diorama-kamera — opgraderet efter launch, og azimuth-grænserne fra dengang er siden fjernet helt.)_
...
- [x] **Kæledyr** — med den bærende regel at **kæledyr ingen behov har**: planterne er dem, man passer; dyrene er selskab. (1) **Frøen**: "En frø (ikke et frø)" i butikken (60 🫧, kræver drivhuset) — et syltetøjsglas på skrivebordet, hvor æg → haletudse → ben → frølet forvandler sig over ~7 dage i realtid (ren kalender-funktion, ingen tick-bogføring — ferier tæller fuldt med), hvorefter frøen flytter ud i drivhuset. Står der en levende trompetkande derude, sidder den ved _den_ — ligesom ægte frøer, der hugger bytte fra kandeplanter. (2) **Katten**: i nogle regnperioder (deterministisk pr. seed + periode, som vejret) sidder en gennemblødt kat og mjaver ved ruden; luk den ind via banner eller ved at tappe den, og den sover fremover på sengen (tap for spinden). (3) **Sneglen**: kravler i sneglefart over karmen i regnvejr (ægte skadedyr for kødædere); tre blide redninger (+2 🫧, cooldown i simmen), og den flytter ind i et glas med lufthuller. Fire achievements (Fuldendt forvandling, Regnvejrsven, Verdens roligste kæledyr, Fuldt hus), `GameState.pets` i save v12, og dyrene følger med på vennebesøg (read-only).
- [x] **Kæledyr, anden bølge**: (4) **Edderkoppen** — efterår er edderkoppesæson: på nogle efterårsdage (deterministisk pr. seed + dag) spinder en lille edderkop prøve-net i hjørnet; lad den blive via banner eller tap, og den beholder et fuldt net og betaler **husleje**: med mellemrum hænger der en indpakket myg i nettet (+2 🫧 med cooldown — aldrig en pligt). Sneglen kommer nu også frem i perioden _lige efter_ regnen (botanisk korrekt — og nødvendigt ved ×600, hvor en regnperiode kun varer sekunder). (5) **Mariehønen** — gæsten der aldrig ejes: lander på karmen til en lille spadseretur (aldrig om vinteren — de går i hi), en hilsen giver +1 🫧 held, og fælderne får aldrig et ord indført: nyttedyr, og smager berømt forfærdeligt. Fuldt hus kræver nu alle **fire** indflyttere; to nye achievements (Bofælle på otte ben, Lykkebringer).
- [x] **Havens gæster** — tre sæsonbestemte besøg, så der er dyreliv året rundt: (6) **Rødhalsen** ved et købbart foderbræt uden for ruden (40 🫧, deko) — kommer forbi om dagen, hakker frø og synger en lille syntetiseret trille, når man hilser (+1 🫧, cooldown). Vinterens ven: den holder _ikke_ hi. (7) **Sommerfuglen** — forår/sommer-gæst der flagrer om karmen, og hvis en fluefanger blomstrer, hviler den på blomsten. Det bærer spillets fineste fakta: kødædende planter sætter blomsten på en høj stilk, netop så bestøverne ikke bliver spist — achievementet hedder "Sikker landing". (8) **Pindsvinet** — lusker over drivhusets græsplæne efter mørkets frembrud og snuser efter snegle (haven's stille ven); sover vintersøvn, så det er en tre-sæsoners gæst. Alle tre er gæster (aldrig ejet), med fælles hilsen-mekanik i simmen (+1 🫧, 2 timers cooldown pr. gæst) og hver sit achievement.

- [x] **Haven** — verden uden for huset som gåbart tredje rum (gratis, altid der): plæne med hvidt stakit og havelåge, husets facade med hoveddør og det store vindue set udefra (gardiner og aftenglød inklusive), blomsterkasse, nedløbsrør ned i regntønden, trædesten, æbletræ, buske, tørresnor og postkasse med flag. Vejret foregår omkring én: regn over hele plænen (og gyldne dråber i det fri), sol, skyer og stjerner på himlen bag huset. Dørene er ægte: en ny dør i værelsets højre væg fører ud i haven, hoveddøren fører ind igen, det ejede drivhus står i havens hjørne med sin egen dør — og drivhusets døråbning fører ud på plænen. Dør-måtter og havens kollisioner er ren matematik i `playerMovement.ts` med tests (inkl. invarianten at ingen dør-ankomst lander på en anden dørs måtte). HUD'ens rumskifter viser nu altid Værelset/Haven (+ Drivhuset når ejet, også på besøg), og pindsvinet lusker også over havens plæne efter mørkets frembrud.
- [x] **Butterwort — art nr. 5**: _Pinguicula_, vibefedt, med spillets første regel-inversion: mange butterworts vokser på kalksten i naturen, så det er den ene plante, hvor postevands-knappen IKKE koster sundhed (nyt `limeTolerant`-flag pr. art). Passiv fangst som soldug, ingen dis, ægte vinterdvale; fladt smørfedtet roset-kit med violet blomst fra voksen-stadiet. Frø til 90 🫧, og "Fuld samling"-achievementet fra den oprindelige plan låses op, når alle fem arter står i samlingen. Save v13 (gamle klienter skal afvise ukendt art — drivhus-præcedens).
- [x] **Plantedagbogen**: hver plante skriver dagbog over sine milepæle — plantet, vækststadier, første fangst, blomsterstilk/blomstring/klip, visnen og redning, dvale og opvågning, ompotning, pyntning og (i hard mode) enden. Simmen skriver siderne dér hvor tingene sker (stepPlant + actions), teksterne bor i locale-filerne, datoer via Intl, loft på 60 sider pr. plante. 📔-knap i HUD'en; migrerede planter åbner på en "dagbogen begynder her"-side.
- [x] **SNAP!-arkaden**: computeren ("absolut ikke til spil") kan nu tappes og starter et retro-minispil: en voksende fluefanger-tunge æder fluer og skal undgå biller — hovedspillets egne regler som pixel-arkade. Piletaster/WASD/swipe + d-pad på touch, canvas i klods-palette. Simmen gemmer rekorden og udbetaler lommepenge (1 🫧 pr. 5 point, loft på 10 🫧 pr. dag — leg, ikke grind); Highscore!-achievement ved 25 point.
- [x] **Frit kamera hele vejen rundt**: azimuth-grænserne (±1,45 rad) er fjernet, så kameraet kan dreje 360° om passeren i alle tre rum — de føltes som "låst til 180 grader". Dollhouse-trikket er generaliseret til de massive kulisser: vinduesvæggen og husets facade gemmer sig automatisk (`<DollhouseWall>`), når kameraet krydser om bag dem. Og fordi himlen kun stod som bagtæppe mod nord (de tre andre verdenshjørner viste papir-baggrunden), er havens og drivhusets himmel nu en tromle rundt om hele plænen — vejr- og døgnfarverne følger med hele vejen rundt, og sol, skybanker og de håndplacerede stjerner sidder på tromlen i alle verdenshjørner (solen dog kun ét sted — der er trods alt kun én). Drivhusets regn falder på plænen rundt om hele glashuset i stedet for kun som en stribe mod nord. Værelset har fået sin fjerde væg: passerens egen tegne-galleri-væg (fluefangeren, solen over huset, passeren og en meget glad flue), der kun er på scenen, når kameraet er inde i rummet og kigger tilbage — forfra er dukkehuset åbent som altid.
- [x] **Sne, fødselsdage og radioens vejrudsigt** — tre plukket fra "hvad kunne vi ellers?"-brainstormen: (1) **Vejrudsigten**: hylderadioen (ejet deko) kan nu tappes og læser udsigten højt med en lille jingle. Vejret har altid været en ren funktion af (seed, tid), så radioen siger bare højt, hvad verden allerede havde planlagt — de næste perioder plus "næste regn til tønden", så vandingen kan planlægges som en rigtig gartner (`weatherForecast`/`nextRainStart` i sim-kernen, deterministisk og testet). (2) **Sne om vinteren**: vinterens 'regn'-perioder falder som sne i alle tre rum (samme vejr, ny dragt — tønden fyldes stadig, for smeltevand løber også i tønder), HUD'en viser 🌨️, plænen ligger under et hvidt tæppe med **fodspor** efter passeren — og på plænen kan der bygges en **snemand** i tre tap (kasket, gulerod og halstørklæde inkluderet): +5 🫧 når hovedet sættes på, achievement første gang, egen kollisionsboks — og den smelter om foråret, så hver vinter bygger sin egen (`snowman` med vinter-nøgle i saven). (3) **Plantefødselsdage**: hver plante kender nu sin plantedato (`plantedAt`, migreret fra dagbogens første side — allerede passerede mærkedage tælles som fejret, ingen fester med tilbagevirkende kraft); hvert år på dagen skriver dagbogen en fødselsdagsside med alderen, potten står under stille konfetti hele dagen, og der betales en lille gave (+5 🫧, achievement ved første fest). Skudårsfrø fejrer 28. februar i almindelige år, dvale-planter fejrer i søvne, og forsømte fødselsdage indhentes blidt af næste tick. Save v19.
- [x] **Resten af brainstormen** — de ni tilbageværende idéer i én omgang: (1) **Regnbuen**: når solskin følger en regnperiode, spænder en klodset regnbue sig af og til over havens østhimmel — tap den og ønsk (som stjerneskud, egen daglig lykkekrukke). (2) **Æbletræet lever efter kalenderen**: lyserød blomstring om foråret, små grønne æbler om sommeren — og om efteråret tre røde, plukbare æbler, der ER dagens lykkekrukke: plukkede æbler er væk til midnat gror dem frem igen. (3) **Blæsevejr**: vind er et lag oven på vejret (ruller pr. periode som alt andet) — tørresnoren blafrer, blade tumler over plænen, HUD'en viser 🍃 — og én gang hvert efterår blæser en **selvsået spire** ind i blomsterkassen; pot den op til en samlerven (+8 🫧). (4) **Ærlig post**: postkassens flag er ikke pynt længere — det er kun oppe, når posten faktisk er kommet (deterministisk pr. dag). Otte breve fra familien (tante Soldug, onkel Kandebærer, bedstefar Trompetkande…) med små sandheder om kødædende planter og +2 🫧 i kuverten. (5) **Havedammen** (120 🫧): stenkant, dunhammere, åkande med sommerblomst — og om sommeren en pilende **guldsmed**, der hilses som havens fineste gæst. (6) **Passerens garderobe**: stråhat til solskinsdage, gul regnjakke og gummistøvler til regnvejr — passeren klæder sig selv på efter vejret, og med støvlerne bliver vandpytterne (under og lige efter regn) hoppedygtige: sjask, lyd og badge. (7) **Formering**: en frodig, voksen plante kan donere et stiklingeblad (✂️-knap, 14 dages hvile pr. plante), der slår rod som en gratis klon — kultivar inklusive, som rigtige samlere gør det. (8) **Frøgaver til venner**: en 🎁-knap i chatten sender frø som en almindelig besked med sløjfe på — serveren aner stadig ingenting (den opbevarer tekst); afsenderens sim betaler butiksprisen, modtagerens planter gaven én gang pr. besked, når der er en ledig potte. (9) **Julekalenderen**: hele december viser HUD'en 🎄 — 24 låger, én om dagen, glemte låger venter pænt (at indhente er halvdelen af traditionen), og låge 24 er selvfølgelig den store. Ni nye achievements, fire nye butiksvarer, save v20 og dækkende tests hele vejen rundt.
